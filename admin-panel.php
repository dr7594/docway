...
.btn-primary{
  ...
  <body style="padding-top:50px; background: linear-gradient(to right, #cc2b5e, #753a88);height: 10em;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;color:#efdcf9;"> Welcome &nbsp<?php echo $username ?> 
   </h3>
    <div class="row" style="background:#efdcf9; margin-left:15px; margin-right:15px; ">
  <div class="col-md-4" style="max-width:25%; margin-top: 3%;background:#efdcf9; margin-left:10px">
  ...
  <div class="col-md-8" style="margin-top: 3%; background:#efdcf9;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px; background:#efdcf9;">


      <div class="tab-pane fade  show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
        <div class="container-fluid container-fullw " style="background:#efdcf9;" >
              <div class="row" style="background:#efdcf9;">
