...
.button1 {background-color: white;} /* Green */
...
<body style="background: -webkit-linear-gradient(left, #cc2b5e , #753a88); background-size: cover;">
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp DocOnWay </h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="contact.html" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>EMERGENCY</h6></a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row" style=>
                    <div class="col-md-3 " style="margin-top: 10%;right: 5% ;">
                        <img src="./images/logo.png" alt="logo" style="height:200px; width:240px;"/>
                        <br/>
                        <h1 style="margin-top:20px; color:#ffffff ;"> &nbsp WELCOME </h1>
                        <h1> &nbsp </h1>
                        <button class="button button1" style="border: 2px solid black ; background:#efdcf9; " onclick="window.location.href='contact.html';"><b>EMERGENCY</b></button>
                        
                    </div>
                    <div class="col-md-9 register-right" style="margin-top: 80px;left: 80px; background:#efdcf9;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 90%;">
                            <li class="nav-item">
