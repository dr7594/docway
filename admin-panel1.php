...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> DocOnWay </a>
...
.btn-primary{
  ...
  <body style="padding-top:50px;background: linear-gradient(to right, #cc2b5e, #753a88);height: 10em;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;color:#efdcf9;"> WELCOME ADMIN </h3>
    <div class="row" style="background:#efdcf9; margin-left:15px; margin-right:15px;">
  <div class="col-md-4" style="max-width:25%;margin-top: 3%; margin-left:10px;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-mes" id="list-mes-list"  role="tab" data-toggle="list" aria-controls="home"> Current Emergencies</a>
      <a class="list-group-item list-group-item-action" href="#list-emer" id="list-mes-emer"  role="tab" data-toggle="list" aria-controls="home">Emergencies</a>
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-emer" role="tabpanel" aria-labelledby="list-mes-emer">
         ...
         <div class="col-md-8">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                      <tr>
                        <td>Dhruv Atri</td>
                        <td>dr75@gmail.com</td>
                        <td>9566612343</td>
                        <td>SRMIST Arch Gate</td>
                        <td> 12-05-2023 </td> <td>12:00 </td>
                      </tr>

                      <tr>
                        <td>Vansh Sharma</td>
                        <td>vvss75@gmail.com</td>
                        <td>9034612343</td>
                        <td>Hostel Arch Gate</td>
                        <td> 14-05-2023 </td> <td>14:06 </td>
                      </tr>

                      <tr>
                        <td>Ram Singh</td>
                        <td>rams@gmail.com</td>
                        <td>9000012343</td>
                        <td>Kundli , Sonipat</td>
                        <td> 13-05-2023 </td> <td>18:55 </td>
                      </tr>

                      <tr>
                        <td>Rahul Gupta</td>
                        <td>rj75@gmail.com</td>
                        <td>8059383888</td>
                        <td>Potheri</td>
                        <td> 14-05-2023 </td> <td>19:40 </td>
                      </tr>

                      <tr>
                        <td>Ruppa Raj</td>
                        <td>rr97@gmail.com</td>
                        <td>9991234768</td>
                        <td>Abode Valley</td>
                        <td> 19-05-2023 </td> <td>11:20 </td>
                      </tr>
