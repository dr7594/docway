...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #cc2b5e , #753a88); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp DocOnWay</h4></a>
    ...
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
      <div class="row">
         ...
         <div class="col-md-7" style="padding-left: 180px; ">
                 <div >
          <img src="images/logo.png" alt="" style="width: 50%; margin-top: 150px;margin-left: 15px;margin-bottom:15px">
      </div>
      ...
      <div style="color: white;">
         ...
         <div class="col-md-4" style="margin-top: 5%;right: 8%">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;background:#efdcf9;">
            <div class="card-body">
              <center>
                <i class="fa fa-hospital-o fa-3x" aria-hidden="true" style="color:#753a88"></i>
                <br>
